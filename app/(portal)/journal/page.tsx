          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                ...
                <path d="M2 7.5C2 10.538 4.686 13 8 13s6-2.462 6-5.5" stroke="var(--text-soft)" strokeWidth="1.5" strokeLinecap="round" />
                <line x1="8" y1="13" x2="8" y2="15.5" stroke="var(--text-soft)" strokeWidth="1.5" strokeLinecap="round" />
                <line x1="5.5" y1="15.5" x2="10.5" y2="15.5" stroke="var(--text-soft)" strokeWidth="1.5" strokeLinecap="round" />
              </svg>
              <span style={{ fontSize: '12px', color: 'var(--text-soft)', fontFamily: 'var(--font-body)' }}>
                Voice Note
              </span>
              {isRecording && (
                <span style={{ fontSize: '11px', color: 'var(--red)', fontFamily: 'var(--font-body)', fontWeight: 500 }}>
              ...
              return (
                <div key={entry.id} style={{ paddingTop: '16px', paddingBottom: '16px', borderTop: '1px solid var(--line)' }}>
                  {editingId === entry.id ? (
                    <div>
                      <textarea
                        ...
                        style={{
                          ...
                          padding: 10, fontSize: 12, fontFamily: 'var(--font-body)',
                      ...
                      <div style={{ display: 'flex', gap: 6 }}>
                        ...
                        <button
                          ...
                          style={{ fontSize: 11, padding: '4px 10px', borderRadius: 6, background: 'none', color: 'var(--text-muted)', border: '1px solid var(--line-md)', cursor: 'pointer', fontFamily: 'var(--font-body)' }}
                        >Cancel</button>
                      </div>
                    </div>
                  ) : (
                    <div>
                      <div
                        onClick={() => { setSelectedEntryId(entry.id); setEntryContent(entry.content) }}
                      ...
                      >
                        ...
                        {parsed.topic && (
                          <div style={{ fontSize: '13px', fontWeight: 500, color: 'var(--ink)', fontFamily: 'var(--font-body)', marginTop: '2px' }}>
                            {parsed.topic}
                          </div>
                        )}
                      ...
                      <div style={{ display: 'flex', gap: 8, marginTop: 8 }}>
                        <button
                          ...
                          style={{ fontSize: 10, padding: '3px 8px', borderRadius: 4, background: 'none', color: 'var(--text-muted)', border: '1px solid var(--line)', cursor: 'pointer', fontFamily: 'var(--font-body)' }}
                        >Edit</button>
                        <button
                          onClick={() => { if (confirm('Delete this entry?')) deleteJournalEntry(entry.id) }}
                          style={{ fontSize: 10, padding: '3px 8px', borderRadius: 4, background: 'none', color: 'var(--red)', border: '1px solid var(--red-pale)', cursor: 'pointer', fontFamily: 'var(--font-body)' }}
                        >Delete</button>
                      </div>
                    </div>
                  )}
