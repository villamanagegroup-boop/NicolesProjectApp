...
const workNavItems: { href: string; label: string; exact?: boolean; icon: (active: boolean) => React.ReactElement }[] = [
  {
    ...
    exact: true,
    icon: (active: boolean) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? '#7A1F1F' : 'var(--text-muted)'} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
...
const circleNavItems: { href: string; label: string; exact?: boolean; icon: (active: boolean) => React.ReactElement }[] = [
  {
    ...
    exact: true,
    icon: (active: boolean) => (
      <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke={active ? '#B8862E' : 'var(--text-muted)'} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
