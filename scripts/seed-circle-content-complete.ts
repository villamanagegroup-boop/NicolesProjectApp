...
This week's only job is to see it. Not fix it. Not judge it. Just name it honestly for the first time.`,
  ...
  },
  {
    ...
    week_title: 'The full picture',
    monday_prompt: 'Record a 2–3 minute voice note describing one specific moment in the last week where you gave before you checked in with yourself. Who was it? What was asked? What did you feel right after — relief, resentment, depletion, nothing at all? Be concrete. You are naming the pattern, not fixing it yet.',
  ...
  },
  {
    ...
    week_title: 'The full picture',
    monday_prompt: 'Record a 2–3 minute voice note saying out loud one thought that has been looping in your head this week. Do not analyze it — just name it. How long has it been running? What does the loop sound like in your own voice when you let it leave your head?',
  ...
  },
  {
    ...
    week_title: 'The full picture',
    monday_prompt: 'Record a 2–3 minute voice note naming the one thing you have started and restarted most over the last year. Say it specifically — the goal, the habit, the project. What does the restart feel like emotionally each time? Shame, frustration, a quiet giving-up?',
  ...
  },
  {
    ...
    week_title: 'The full picture',
    monday_prompt: 'Record a 2–3 minute voice note about what your body is telling you right now. Scan from your feet up. Name three sensations you have been overriding — a tightness, a fatigue, an ache, a numbness. Say them out loud, even the small ones. How long have they been there?',
...
Those children were doing the only thing they knew. This week, you see them clearly — and you begin to separate their survival strategy from your identity.`,
  ...
  },
  {
    ...
    week_title: 'The origin',
    monday_prompt: 'Record a 2–3 minute voice note: Who first taught you that being needed was how you stayed safe or loved? Speak it without softening — name the relationship or the environment honestly. What did giving get you then that felt essential to your belonging?',
  ...
  },
  {
    ...
    week_title: 'The origin',
    monday_prompt: 'Record a 2–3 minute voice note: When did constant mental activity first feel like safety? Speak about what was unpredictable then — who, what, when. What was your mind protecting you from? The throne was built for a reason. Name the reason out loud.',
  ...
  },
  {
    ...
    week_title: 'The origin',
    monday_prompt: 'Record a 2–3 minute voice note about the last time you were truly in momentum. What were the conditions — when, where, what was your environment like, what had you done the night before? Speak it specifically. You are mapping your flow blueprint out loud.',
  ...
  },
  {
    ...
    week_title: 'The origin',
    monday_prompt: 'Record a 2–3 minute voice note: When did you first learn that stopping was not safe — that needing rest made you lazy or a burden? Speak about the version of you who learned it. What was she navigating? What did pushing through get her that felt worth the cost?',
...
This is that week.`,
  ...
  },
  {
    ...
    week_title: 'The cost',
    monday_prompt: 'Record a 2–3 minute voice note naming three specific things being over-accessible has cost you. Not categories — name the friendship that went one-directional, the opportunity you were too depleted to take, the version of yourself you put on hold. Say each one out loud.',
  ...
  },
  {
    ...
    week_title: 'The cost',
    monday_prompt: 'Record a 2–3 minute voice note: Name one specific thing your overthinking has cost you. A conversation you rehearsed instead of having. A move you did not make because you were still preparing. Say it out loud without minimizing. Let it be what it is.',
  ...
  },
  {
    ...
    week_title: 'The cost',
    monday_prompt: 'Record a 2–3 minute voice note about one small promise you broke to yourself in the last year. Name it specifically — "I told myself I would finally ___." Speak honestly about what the accumulation of these broken promises has done to your belief in yourself.',
  ...
  },
  {
    ...
    week_title: 'The cost',
    monday_prompt: 'Record a 2–3 minute voice note: What physical symptom have you normalized? A pain, a tension, a sleep pattern, an illness that arrives every time you finally stop? Say it out loud as the real cost it is. How much of your own life have you been too depleted to actually experience?',
...
This week you make it.`,
  ...
  },
  {
    ...
    week_title: 'The decision',
    monday_prompt: 'Record a 2–3 minute voice note speaking your decision statement out loud. "I am done with ___. Starting now, I choose ___." Both halves specific to your exact pattern — not generic. Say it as a real decision, not an intention. This is your Month 2 anchor.',
  ...
  },
  {
    ...
    week_title: 'The decision',
    monday_prompt: 'Record a 2–3 minute voice note saying your Month 2 declaration out loud. "I am done thinking instead of living. When I feel the urge to overthink ___, my new move is ___." Fill both blanks with specifics. Speak it as a promise to your future self at 11pm in the spiral.',
  ...
  },
  {
    ...
    week_title: 'The decision',
    monday_prompt: 'Record a 2–3 minute voice note saying your declaration out loud. "I am done restarting from zero. My new pattern is ___. When life interrupts, my minimum move is ___." Make it specific enough that tomorrow morning you could act on it without thinking. Embarrassingly small is right.',
  ...
  },
  {
    ...
    week_title: 'The decision',
    monday_prompt: 'Record a 2–3 minute voice note speaking to your body. Acknowledge what you have asked it to carry. Make one specific promise out loud — not a habit, a relationship promise. What are you committing to from here? Say it as something you mean.',
...
Your job this week is not to do it perfectly. It is to do it once. One real interruption. And to notice what happens on the other side of it.`,
  ...
  },
  {
    ...
    week_title: 'The first real interruption',
    monday_prompt: 'Record a 2–3 minute voice note: Before you say your first deliberate "let me get back to you" this week, speak the fear out loud. What do you think will happen if you pause? What are you afraid of losing or breaking? Name the fear before you live the interruption.',
  ...
  },
  {
    ...
    week_title: 'The first real interruption',
    monday_prompt: 'Record a 2–3 minute voice note: Name the one thing you have been thinking about for more than two weeks without acting. Say it specifically out loud. This week you are going to move on it imperfectly. The naming is the start of the move.',
  ...
  },
  {
    ...
    week_title: 'The first real interruption',
    monday_prompt: 'Record a 2–3 minute voice note speaking your minimum viable move out loud as a commitment. "This week, every day, no matter what, I will ___." Say it as something you mean — even on the hardest day. Especially on the hardest day.',
  ...
  },
  {
    ...
    week_title: 'The first real interruption',
    monday_prompt: 'Record a 2–3 minute voice note describing your proactive rest practice for this week. Say it specifically out loud — when, what, where. Make it real by speaking it before you have to live it. This is the protocol, not an intention.',
...
Do not stop now. Do not restart. Do not decide the program is not working. Just keep showing up in the minimum version. Keep making the one choice. Keep writing the one entry. The breakthrough is not coming — it is already happening, underneath the difficulty.`,
  ...
  },
  {
    ...
    week_title: 'When it gets hard',
    monday_prompt: 'Record a 2–3 minute voice note about the moment this week you can already feel the pattern testing you. Who is going to ask for something? Where is the pull strongest? Name it out loud before it happens — you are taking away its surprise.',
  ...
  },
  {
    ...
    week_title: 'When it gets hard',
    monday_prompt: 'Record a 2–3 minute voice note about the spiral that is closest to surfacing this week. What is the trigger? What is the looping thought sound like out loud? You are mapping the terrain before you walk through it.',
  ...
  },
  {
    ...
    week_title: 'When it gets hard',
    monday_prompt: 'Record a 2–3 minute voice note: Where is the urge to quit or restart strongest right now? Speak the story your mind is telling out loud. "I already broke the streak." "What is the point." "I will start fresh Monday." Name it so it loses its grip.',
  ...
  },
  {
    ...
    week_title: 'When it gets hard',
    monday_prompt: 'Record a 2–3 minute voice note: What signal is your body sending right now that you can already feel yourself wanting to override? Say it out loud. Acknowledge it before the override happens. Naming it is the first interruption.',
...
The shift is real. The evidence is already there. You just have to stop long enough to see it.`,
  ...
  },
  {
    ...
    week_title: 'Building the new default',
    monday_prompt: 'Record a 2–3 minute voice note about one moment last week where the pause happened automatically — without you having to remind yourself. Describe it out loud in detail. What were the conditions? What made it possible? You are catching the new identity in real time.',
  ...
  },
  {
    ...
    week_title: 'Building the new default',
    monday_prompt: 'Record a 2–3 minute voice note about a decision you made last week without spiraling. Describe what it felt like in your body — the moment right before you moved, the moment after. You are documenting the new identity as it appears in real time.',
  ...
  },
  {
    ...
    week_title: 'Building the new default',
    monday_prompt: 'Record a 2–3 minute voice note about one moment last week where you kept going after an interruption — without the internal debate. Speak about what made it feel natural. Even almost continuing is different from automatically stopping. Catch the new way in your voice.',
  ...
  },
  {
    ...
    week_title: 'Building the new default',
    monday_prompt: 'Record a 2–3 minute voice note about a moment last week where you stopped before the wall and it felt okay. What allowed it? What was different about that moment? Speak it specifically. Rest as a choice instead of a surrender — that is the new identity in real time.',
...
You built something real in eight weeks. Month 3 is where it becomes permanent.`,
  ...
  },
  {
    ...
    week_title: 'Month 2 integration',
    monday_prompt: 'Record a 2–3 minute voice note comparing the Open Door at Week 1 versus today. What does she do differently now? What does she no longer do automatically? What has she gotten back — what time, energy, peace, or version of herself? Speak it as fact.',
  ...
  },
  {
    ...
    week_title: 'Month 2 integration',
    monday_prompt: 'Record a 2–3 minute voice note listing out loud the most significant decisions you made in Month 2 without spiraling. Not feelings — actions. Say the evidence. The facts are the identity shift made audible.',
  ...
  },
  {
    ...
    week_title: 'Month 2 integration',
    monday_prompt: 'Record a 2–3 minute voice note reading your Month 2 evidence log out loud. Every minimum move, every kept promise, every day you showed up. Hear yourself say it. That is your self-trust ledger.',
  ...
  },
  {
    ...
    week_title: 'Month 2 integration',
    monday_prompt: 'Record a 2–3 minute voice note comparing the Pushthrough at Week 1 versus today. What does she listen to now that she used to override? What has she stopped requiring herself to earn? Speak the relationship that has changed.',
...
That is your new identity. And this month we make it permanent.`,
  ...
  },
  {
    ...
    week_title: 'Name the new identity',
    monday_prompt: 'Record a 2–3 minute voice note saying your new identity statement out loud. "I am someone who ___." Three specific behaviors you now do that the old Open Door did not. Present tense. Already true. Not who you are becoming — who you are.',
  ...
  },
  {
    ...
    week_title: 'Name the new identity',
    monday_prompt: 'Record a 2–3 minute voice note saying your new identity out loud. "I am someone who ___." Three statements based on decisions you have made, actions you have taken, spirals you have interrupted. Present-tense fact, not aspiration.',
  ...
  },
  {
    ...
    week_title: 'Name the new identity',
    monday_prompt: 'Record a 2–3 minute voice note saying your new identity out loud. "I am someone who ___." Base it entirely on the evidence — what you have actually completed, continued, finished. Hear yourself say it. This is a report on what has already happened.',
  ...
  },
  {
    ...
    week_title: 'Name the new identity',
    monday_prompt: 'Record a 2–3 minute voice note saying your new identity out loud. "I am someone who ___." Three specific statements based on how you have treated your body in the last eight weeks. Already true, not aspirational. Speak what you have proven.',
...
You are not protecting against failure. You are protecting against the moment of forgetting — the moment where the old way feels like the only way again. With a protocol, you have a different option ready.`,
  ...
  },
  {
    ...
    week_title: 'Protect the new identity',
    monday_prompt: 'Record a 2–3 minute voice note naming the people or environments most likely to pull you back into the old pattern. Be honest about who and where. For one of them, speak your response protocol out loud — "When ___ happens with ___, I will ___."',
  ...
  },
  {
    ...
    week_title: 'Protect the new identity',
    monday_prompt: 'Record a 2–3 minute voice note: Under what specific conditions does your overthinking resurface most reliably? Name the triggers out loud — stress, certain decisions, late at night, uncertainty. You are building an early warning system, and it starts with naming the signal.',
  ...
  },
  {
    ...
    week_title: 'Protect the new identity',
    monday_prompt: 'Record a 2–3 minute voice note about the season or stressor most likely to break your momentum. Name it specifically. Speak the minimum viable move that protects the engine through that season. The protocol only works if it is built in advance — out loud.',
  ...
  },
  {
    ...
    week_title: 'Protect the new identity',
    monday_prompt: 'Record a 2–3 minute voice note about when the pushthrough is most likely to return. High-stakes situations, certain relationships, times you feel watched. Name each trigger out loud — and the body-first response you will use. "When I feel ___, before I push, I will ___."',
...
You built something real. Now you just get to live in it.`,
  ...
  },
  {
    ...
    week_title: 'Living from the new identity',
    monday_prompt: 'Record a 2–3 minute voice note describing one full day living as the new version of you. Morning to night. How she starts, how she gives, how she pauses before she says yes, how she ends the day with something for herself. Speak it specifically — a life that is already yours.',
  ...
  },
  {
    ...
    week_title: 'Living from the new identity',
    monday_prompt: 'Record a 2–3 minute voice note: What becomes possible in your life — specifically — when your mind is a tool you direct rather than a room you are trapped in? Speak that life in present tense. What do you make, build, decide that did not exist before?',
  ...
  },
  {
    ...
    week_title: 'Living from the new identity',
    monday_prompt: 'Record a 2–3 minute voice note about the thing you have been building toward — the thing the Interrupted Engine kept stopping before it could become real. What is the first real move this month? Name it with a specific date out loud. Not someday — said.',
  ...
  },
  {
    ...
    week_title: 'Living from the new identity',
    monday_prompt: 'Record a 2–3 minute voice note about what becomes possible when you are no longer running on fumes. What version of yourself has been waiting for you to have enough in reserve? Speak her into the room. You have been working toward her for 90 days.',
...
I will see you on our final call.`,
  ...
  },
  {
    ...
    week_title: 'Graduation',
    monday_prompt: 'Record a 2–3 minute voice note: Speak your transformation story out loud. Who you were when you arrived. What you did. Who you are now. Three parts. Say it for yourself first. This is the version you will return to when the old story tries to come back.',
  ...
  },
  {
    ...
    week_title: 'Graduation',
    monday_prompt: 'Record a 2–3 minute voice note: Speak your transformation story out loud. The mind that never stopped. The decisions made under 60 seconds. The person who now thinks powerfully and lives fully. Hear it in your own voice. Hear who you have become.',
  ...
  },
  {
    ...
    week_title: 'Graduation',
    monday_prompt: 'Record a 2–3 minute voice note: Speak your transformation story out loud. The restarts. The minimum moves. The streak. The engine that runs in any weather. Say the evidence clearly enough to return to when the old story tries to come back.',
  ...
  },
  {
    ...
    week_title: 'Graduation',
    monday_prompt: 'Record a 2–3 minute voice note: Speak your transformation story out loud. The overrides. The first time you stopped before the wall. The person who has proven she does not have to push through to be strong. Say it with the same strength you brought to everything else.',
...
function toDbRow(c: SourceRow) {
  return {
    ...
    monday_prompt:    c.monday_prompt    ?? null,   // archetype voice-note prompt
