...
export const MOCK_CALLS: LiveCall[] = [
  {
    ...
    notes: 'We introduced everyone and set the 90-day frame. Replay up now.',
  },
  {
    id: 'mock-call-2',
    call_number: 2,
  ...
  },
  {
    id: 'mock-call-4',
    call_number: 4,
    title: 'Identity shift moments',
    scheduled_at: new Date(now + 31 * DAY).toISOString(),
    zoom_url: 'https://zoom.us/j/mock-circle',
    recording_url: null,
    notes: null,
  },
  {
    ...
    scheduled_at: new Date(now + 45 * DAY).toISOString(),
    zoom_url: 'https://zoom.us/j/mock-circle',
    recording_url: null,
    notes: null,
  },
  {
    ...
    call_number: 6,
    title: 'Graduation',
    scheduled_at: new Date(now + 73 * DAY).toISOString(),
    zoom_url: 'https://zoom.us/j/mock-circle',
    recording_url: null,
    notes: null,
  },
